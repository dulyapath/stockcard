                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="${sublink}index.jsp" class="site_title">SML <span>MIS V.2</span></a>
                        </div>
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li class=""><a><i class="fa fa-file-text-o"></i> ยอดคงเหลือ <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <li ><a href="${sublink}balance_purc/list.jsp"><i class="fa fa-file-text-o"></i>ยอดคงเหลือสินค้า(จัดซื้อ)</a></li>
                                            <li ><a href="${sublink}balance_con/list.jsp"><i class="fa fa-file-text-o"></i>ยอดคงเหลือสินค้า(มีเงื่อนไข)</a></li>
                                            <li ><a href="${sublink}balance_lot"><i class="fa fa-file-text-o"></i>ยอดคงเหลือสินค้าตามLOT</a></li>
                                            <li ><a href="${sublink}dimension/list.jsp"><i class="fa fa-file-text-o"></i>รายงานสินค้าแยกตามกลุ่มโปรโมชั่น</a></li>
                                            <li ><a href="${sublink}dimension/list2.jsp"><i class="fa fa-file-text-o"></i>รายงานการขายสินค้าเรียงตามลูกค้า แยกการขายตามกลุ่มโปรโมชั่น</a></li>
                                        </ul>
                                    </li>

                                    <li class=""><a><i class="fa fa-file-text-o"></i> สถานะ <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li ><a href="${sublink}bankstatement/list.jsp"><i class="fa fa-file-text-o"></i>Bank Statement</a></li>
                                            <li ><a href="${sublink}arcustomer/list.jsp"><i class="fa fa-file-text-o"></i>ลูกหนี้</a></li>
                                            <li ><a href="${sublink}sale/salestatus.jsp"><i class="fa fa-file-text-o"></i>ใบสั่งจอง</a></li>
                                            <li ><a href="${sublink}sale/sale.jsp"><i class="fa fa-file-text-o"></i>ใบสั่งขาย</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a href="${sublink}sale/saleapprove.jsp"><i class="fa fa-file-text-o"></i>การอนุมัติใบสั่งจอง</a></li>
                                    <li><a href="${sublink}sale01/list.jsp"><i class="fa fa-file-text-o"></i>ใบสั่งขายที่ยังไม่เปิดบิลขาย</a></li>
                                    <li><a href="${sublink}sale02/list.jsp"><i class="fa fa-file-text-o"></i>ใบสั่งจองที่ยังไม่เปิดบิลขาย</a></li>
                                    <li><a href="${sublink}barcode/list.jsp"><i class="fa fa-file-text-o"></i>ตรวจทานยอดคงเหลือสินค้าด้วยบาร์โค้ด</a></li>
                                    <li><a href="${sublink}barcodeprice/list.jsp"><i class="fa fa-file-text-o"></i>ราคาสินค้าตาม Barcode</a></li>
                                    <li><a href="${sublink}getImg/list.jsp"><i class="fa fa-file-text-o"></i>ปรับขนาดรูปภาพ</a></li>
