...
<%    String pageName = "นำเข้ารายการ";
    ...
    request.setAttribute("js", Arrays.asList("../js/sweetalert.min.js", "../conf.js", "../js/stock_import/stock_import.js"));
            ...
            <div class="row" style="margin-bottom: 0.5rem">
                <div class="col-md-12">
                    ...
                    <button class="btn btn-success btn-add">
                        <i class="fas fa-plus"></i> สร้างเอกสารนำเข้า
                    </button>
