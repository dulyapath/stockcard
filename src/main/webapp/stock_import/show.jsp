...
<%    String pageName = "เอกสารนำเข้า";
    ...
    request.setAttribute("js", Arrays.asList("../js/sweetalert.min.js", "../conf.js", "../js/stock_import/formshow.js"));
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-top:5px">
                                <div class="col-4">
                                    ...
                                    <div class="">
                                        <input class="form-control" type="text"  id="doc_ref" value="" readonly>
                                    </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id='doc_type' readonly></input>
                                    </div>
                                </div>
                                <div class="col-4" >
                            ...
                            <div class="row" style="margin-top:5px">
                                <div class="col-8">
                                    ...
                                    <div class="">
                                        <input class="form-control" type="text"  id="remark" value="" readonly>
                                    </div>
                                </div>
