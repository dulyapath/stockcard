...
@WebServlet(name = "groupsub-list", urlPatterns = {"/getGroupsub"})
public class getGroupsup extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "select code,name_1 from ic_group_sub order by code";
