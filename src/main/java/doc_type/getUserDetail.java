...
@WebServlet(name = "userDetail", urlPatterns = {"/getUserDetail"})
public class getUserDetail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "select code as user_code ,name_1 as user_name,ic_wht as wh_code,coalesce((select name_1 from ic_warehouse where code = ic_wht),'') as wh_name  from erp_user where upper(code)=upper('" + __user + "')";
