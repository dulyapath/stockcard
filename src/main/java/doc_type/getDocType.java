...
@WebServlet(name = "getdoc-type", urlPatterns = {"/getDocType"})
public class getDocType extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "select * from sc_doctype order by create_datetime desc";
