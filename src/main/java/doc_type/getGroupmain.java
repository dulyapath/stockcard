...
@WebServlet(name = "groupmain-list", urlPatterns = {"/getGroupmain"})
public class getGroupmain extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "select code,name_1 from ic_group order by code";
