...
@WebServlet(name = "getware_house", urlPatterns = {"/getWarehouse"})
public class getWarehouse extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "select code,name_1 as name  from ic_warehouse ";
            ...
            while (__rsHead.next()) {
                ...
                obj.put("name", __rsHead.getString("name"));
                jsarr.put(obj);
            }
