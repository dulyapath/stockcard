...
@WebServlet(name = "del-doctype-save", urlPatterns = {"/delDocType"})
public class delDocType extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement __stmt_delete = __conn.prepareStatement("delete from sc_doctype where code = '" + _code + "';");

            System.out.println(__stmt_delete);
