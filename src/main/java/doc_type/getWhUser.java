...
@WebServlet(name = "wh_user", urlPatterns = {"/getWhUser"})
public class getWhUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "select ic_wht,ic_shelf  from erp_user where upper(code)=upper('" + __user + "')";
            ...
            while (__rsHead.next()) {
                ...
                _sess.setAttribute("wh_code", __rsHead.getString("ic_wht"));
                _sess.setAttribute("shelf_code", __rsHead.getString("ic_shelf"));
                obj.put("ic_wht", __rsHead.getString("ic_wht"));
                obj.put("ic_shelf", __rsHead.getString("ic_shelf"));
                jsarr.put(obj);
            }
